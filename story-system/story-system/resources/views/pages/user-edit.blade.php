			...
			<div class="m-0 p-3 row">
				<div class="p-3" style="width: 400px;height: 500px;margin: auto;border:3px solid #f7f8fa">
					<form action="{{ url('user-edit') }}" method="POST" enctype='multipart/form-data'>
						{{ csrf_field()}}
						<input value="{{$UserDetail->id}}" type="" name="id" style="display: none;">
						...
						<div class="mb-2" style="display: flex;">
							...
							<input value="{{$UserDetail->passport}}" type="number" class="form-control" name="passport" required>
						</div>
						...
						<div class="mb-2" style="display: flex;">
							...
							<input value="{{$UserDetail->name}}" type="text" class="form-control" name="name" required>
						</div>
						...
						<div class="mb-2" style="display: flex;">
							...
							<input value="{{$UserDetail->address}}" type="text" class="form-control" name="address" required>
						</div>
						...
						<div class="mb-2" style="display: flex;">
							...
							<input value="{{$UserDetail->phone}}" type="number" class="form-control" name="phone" required>
						</div>
						<label class="font-weight-bold">Image</label>
						<div class="mb-2" style="display: flex;">
							<div class="mr-1 text-center" style="width: 50px;height: 50px;border: 2px dashed #ff5722;">
								<img src="../images/avatars/{{$UserDetail->image}}" width="100%" height="100%">
							</div>
