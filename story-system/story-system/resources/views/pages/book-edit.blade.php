			...
			<div class="m-0 p-3 row">
				<div class="p-2" style="width: 700px;margin: auto;border:3px solid #f7f8fa">
					<form action="{{ url('book-edit') }}" method="POST" enctype='multipart/form-data'>
						{{ csrf_field()}}
						<input value="{{$BookDetail->id}}" type="" name="id" style="display: none;">
						<div class="row m-0">
							<div class="col-6 p-2">
								...
								<div class="mb-2" style="display: flex;">
									...
									<input value="{{$BookDetail->name}}" type="text" class="form-control" name="name" required>
								</div>
							</div>
							<div class="col-6 p-2">
								...
								<div class="mb-2" style="display: flex;">
									...
									<input value="{{$BookDetail->price}}" type="number" class="form-control" name="price" required>
								</div>
							</div>
							<div class="col-6 p-2">
								...
								<div class="mb-2" style="display: flex;">
									...
									<select class="form-control" name="category" value="{{$BookDetail->namecategory}}">
										@foreach($Category as $Category)
										<option value="{{$Category->id}}" @if($Category->id == $BookDetail->idcategory) selected @endif>{{$Category->name}}</option>								
										@endforeach
									</select>
								</div>
							</div>
							<div class="col-6 p-2">
								...
								<div class="mb-2" style="display: flex;">
									...
									<input value="{{$BookDetail->quanlity}}" type="number" class="form-control" name="quanlity" required>
								</div>
							</div>
							<div class="col-2 p-2">
							...
							<div class="col-10 p-2">
								...
								<textarea class="form-control" name="note" required  style="width: 100%;height: 125px">{{$BookDetail->note}}
								</textarea>							
							</div>
