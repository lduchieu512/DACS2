                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="search_box pull-right">
                            <input type="text" name="keywords_submit" placeholder="Tìm kiếm sảm phẩm"/>
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <img src="{{('public/frontrnd/images/pricing.png')}}"  class="pricing" alt="" />
                                </div>
                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{('public/frontrnd/images/girl3.jpg')}}" class="girl img-responsive" alt="" />
                                    <img src="{{('public/frontrnd/images/pricing.png')}}" class="pricing" alt="" />
                                </div>
                            </div>
                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{('public/frontend/images/iframe3.png')}}" alt="" />                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                                </a>
